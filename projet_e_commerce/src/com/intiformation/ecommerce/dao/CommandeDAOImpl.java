...
/**
 * implémentation concrète de la couche DAO pour les commandes implémente
 * l'interface ICommandeDAO
 * 
 * @author marle
 *
 */
public class CommandeDAOImpl implements ICommandeDAO {
	 ...
	 * 
	 * @param pIdCommande
	 *            : l'id de la commande à rechercher
	 */
	@Override
	 ...
	 * 
	 * @param pIdCommande
	 *            : l'id de la commande à supprimer
	 */
	@Override
	...
	public int getIdByLastAdd() {
		...
		try {
			ps = this.connection.prepareStatement("SELECT id_commande FROM commandes ORDER BY id_commande DESC");
			...
			System.out.println("...(CommandeDAOImpl) erreur de l'execution de getIdByLastAdd()...");
			e.printStackTrace();
	...
	public List<Commande> getAllByIdClient(int pIdClient) {
		try {
			...
			System.out.println("...(CommandeDAOImpl) erreur de l'execution de getAllByIdClient()...");
			e.printStackTrace();
